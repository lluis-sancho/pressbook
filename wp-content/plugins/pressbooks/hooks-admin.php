...
if ( $is_book ) {
	...
	add_action( 'save_post_metadata', '\Pressbooks\Admin\Metaboxes\upload_front_image', 10, 2 );
...
add_action( 'wp_ajax_pb_delete_front_image', '\Pressbooks\Admin\Metaboxes\delete_front_image' );
