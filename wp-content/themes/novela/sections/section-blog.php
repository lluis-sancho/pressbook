<section class="blog-information block-section" id="<?php echo esc_attr(sdesigns_get_sub_field('navigation_menu_anchor')); ?>" >
	...
	<?php $query = new WP_Query( array(
		'post_type' => 'post',
		'max_num_pages' => 1,
		'posts_per_page' => sdesigns_get_sub_field('number_of_recent_posts')
	));
